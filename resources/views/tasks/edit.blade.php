...
<div class="flex items-center justify-between mb-0">
    <h1 class="font-bold text-gray-900 dark:text-gray-100">✏️ Edit Task</h1>
...
<form action="{{ route('tasks.update', $task->id) }}" method="POST" class="max-w-7xl mx-auto space-y-6 border dark:bg-gray-800 px-4 rounded-lg shadow">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div class="md:col-span-3">
            ...
            <textarea name="description" id="description" rows="4"
                      class="w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded px-3 py-2">{{ old('description', $task->description) }}</textarea>
        </div>
